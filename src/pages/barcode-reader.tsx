...
function BarCodeReader() {
  ...
  return (
    ...
    <span className="min-h-[8vh] p-2 mt-4 mb-4 bg-white"><h1 className="font-semibold text-4xl flex items-center justify-center my-auto">IDSDK - MRZ/Barcode Recognition</h1></span> 
      <article className="flex w-full border  bg-bgPlayground">
        <div className="flex flex-col items-center w-5/12 bg-white">
          <UploadAndPreview
            pageType={PageType.BARCODE}
            updateData={setData}
